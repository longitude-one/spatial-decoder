...
const PACKAGE_VERSION_PATTERN = new RegExp(
  `(composer require longitude-one/spatial-decoder:)(${SEMVER_PATTERN})(?=\\s|$)`,
);
...
module.exports.readVersion = function (contents) {
  ...
  if (!match) {
    throw new Error('readme-version-updater: No Spatial Decoder installation version found in README.md.');
  }
